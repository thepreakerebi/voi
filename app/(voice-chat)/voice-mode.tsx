...
export default function VoiceMode({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <section className="w-full h-full md:px-2 md:py-8">
      <section className="grid w-full h-full grid-cols-1 md:grid-cols-2 gap-4">
        <section className="rounded-[20px] w-full bg-card h-full overflow-hidden md:pb-1 md:pt-6">
